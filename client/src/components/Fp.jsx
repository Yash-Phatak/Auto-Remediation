...
function Fp({ open }) {
  return (
    <>
      <div className={`${fpc.bdy} max-w-[100%]`}>
        <div className={`${fpc.heading} flex flex-row max-md:flex-col`}>

          <div className='flex flex-col items-start pr-7 justify-center'>
          ...
          <img src={img} alt="main" className='max-w-[450px] max-h-[450px] m-auto' />
        </div>

        <div className='flex justify-around items-center flex-1 mt-28 max-lg:flex-col max-w-[100vw]'>
